...
// Filters
void PreFilterMeasuredSignals(const ControlParameters& CntrPar, LocalVariables& LocalVar, debugvariables_t* DebugVar, objectinstances_t* objInst, errorvariables_t* ErrVar);
...
// SubControllers
void IPC(const ControlParameters& CntrPar, LocalVariables& LocalVar, objectinstances_t* objInst, debugvariables_t* DebugVar, errorvariables_t* ErrVar);
...
// Estimators
void WindSpeedEstimator(LocalVariables& LocalVar, const ControlParameters& CntrPar, objectinstances_t* objInst, const PerformanceData& PerfData, debugvariables_t* DebugVar, errorvariables_t* ErrVar);
...
void SpeedSetpoints(const ControlParameters& CntrPar, LocalVariables& LocalVar, objectinstances_t* objInst, debugvariables_t* DebugVar, errorvariables_t* ErrVar);
...
void SetParameters(const ControlParameters& CntrPar, LocalVariables& LocalVar, float* avrSWAP, objectinstances_t* objInst, errorvariables_t* ErrVar, int size_avcMSG);
...
void WriteRestartFile(LocalVariables& LocalVar, const ControlParameters& CntrPar, errorvariables_t* ErrVar, objectinstances_t* objInst, char* RootName, int size_avcOUTNAME);
void ReadRestartFile(float* avrSWAP, LocalVariables& LocalVar, const ControlParameters& CntrPar, objectinstances_t* objInst, const PerformanceData& PerfData, char* RootName, int size_avcOUTNAME, errorvariables_t* ErrVar);
