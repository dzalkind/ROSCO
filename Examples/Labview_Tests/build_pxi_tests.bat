...
g++ -m32 -shared -static -static-libgcc -static-libstdc++ -DBUILD_TEST1 -o test_1.dll pxi_tests.c -Wl,--kill-at
if errorlevel 1 (echo FAILED & goto :eof)

echo Building test_2 (new/delete) ...
g++ -m32 -shared -static -static-libgcc -static-libstdc++ -DBUILD_TEST2 -o test_2.dll pxi_tests.c -Wl,--kill-at
if errorlevel 1 (echo FAILED & goto :eof)

echo Building test_3 (std::string) ...
g++ -m32 -shared -static -static-libgcc -static-libstdc++ -DBUILD_TEST3 -o test_3.dll pxi_tests.c -Wl,--kill-at
if errorlevel 1 (echo FAILED & goto :eof)

echo Building test_4 (C file I/O) ...
g++ -m32 -shared -static -static-libgcc -static-libstdc++ -DBUILD_TEST4 -o test_4.dll pxi_tests.c -Wl,--kill-at
if errorlevel 1 (echo FAILED & goto :eof)

echo Building test_5 (C++ streams) ...
g++ -m32 -shared -static -static-libgcc -static-libstdc++ -DBUILD_TEST5 -o test_5.dll pxi_tests.c -Wl,--kill-at
if errorlevel 1 (echo FAILED & goto :eof)

echo Building test_6 (strings + malloc + snprintf + getenv) ...
g++ -m32 -shared -static -static-libgcc -static-libstdc++ -DBUILD_TEST6 -o test_6.dll pxi_tests.c -Wl,--kill-at
if errorlevel 1 (echo FAILED & goto :eof)
