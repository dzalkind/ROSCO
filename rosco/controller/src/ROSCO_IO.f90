...
! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
    ...
    CHARACTER(15), DIMENSION(169)      :: LocalVarOutStrings
    ...
    LocalVarOutData(83) = LocalVar%FA_Vel
    LocalVarOutData(84) = LocalVar%NacIMU_FA_Vel
    ...
    LocalVarOutData(122) = LocalVar%NACIMU_FA_AccF
    LocalVarOutData(123) = LocalVar%FA_AccF
    LocalVarOutData(124) = LocalVar%FA_Hist
    LocalVarOutData(125) = LocalVar%TRA_LastRefSpd
    LocalVarOutData(126) = LocalVar%VS_RefSpeed
    LocalVarOutData(127) = LocalVar%PtfmTDX
    LocalVarOutData(128) = LocalVar%PtfmTDY
    LocalVarOutData(129) = LocalVar%PtfmTDZ
    LocalVarOutData(130) = LocalVar%PtfmRDX
    LocalVarOutData(131) = LocalVar%PtfmRDY
    LocalVarOutData(132) = LocalVar%PtfmRDZ
    LocalVarOutData(133) = LocalVar%PtfmTVX
    LocalVarOutData(134) = LocalVar%PtfmTVY
    LocalVarOutData(135) = LocalVar%PtfmTVZ
    LocalVarOutData(136) = LocalVar%PtfmRVX
    LocalVarOutData(137) = LocalVar%PtfmRVY
    LocalVarOutData(138) = LocalVar%PtfmRVZ
    LocalVarOutData(139) = LocalVar%PtfmTAX
    LocalVarOutData(140) = LocalVar%PtfmTAY
    LocalVarOutData(141) = LocalVar%PtfmTAZ
    LocalVarOutData(142) = LocalVar%PtfmRAX
    LocalVarOutData(143) = LocalVar%PtfmRAY
    LocalVarOutData(144) = LocalVar%PtfmRAZ
    LocalVarOutData(145) = LocalVar%PtfmRDX_F
    LocalVarOutData(146) = LocalVar%PtfmRDY_F
    LocalVarOutData(147) = LocalVar%Force_Pitch
    LocalVarOutData(148) = LocalVar%Force_Roll
    LocalVarOutData(149) = LocalVar%StC_FR_Target
    LocalVarOutData(150) = LocalVar%StC_FP_Target
    LocalVarOutData(151) = LocalVar%StC_Fi_Target(1)
    LocalVarOutData(152) = LocalVar%StC_Fill_State(1)
    LocalVarOutData(153) = LocalVar%CC_DesiredL(1)
    LocalVarOutData(154) = LocalVar%CC_ActuatedL(1)
    LocalVarOutData(155) = LocalVar%CC_ActuatedDL(1)
    LocalVarOutData(156) = LocalVar%StC_Input(1)
    LocalVarOutData(157) = LocalVar%Flp_Angle(1)
    LocalVarOutData(158) = LocalVar%RootMyb_Last(1)
    LocalVarOutData(159) = LocalVar%ACC_INFILE_SIZE
    LocalVarOutData(160) = LocalVar%AWC_complexangle(1)
    LocalVarOutData(161) = LocalVar%TiltMean
    LocalVarOutData(162) = LocalVar%YawMean
    LocalVarOutData(163) = LocalVar%ZMQ_ID
    LocalVarOutData(164) = LocalVar%ZMQ_YawOffset
    LocalVarOutData(165) = LocalVar%ZMQ_TorqueOffset
    LocalVarOutData(166) = LocalVar%ZMQ_PitOffset(1)
    LocalVarOutData(167) = LocalVar%ZMQ_R_Speed
    LocalVarOutData(168) = LocalVar%ZMQ_R_Torque
    LocalVarOutData(169) = LocalVar%ZMQ_R_Pitch
    ...
    LocalVarOutStrings(83) = 'FA_Vel'
    LocalVarOutStrings(84) = 'NacIMU_FA_Vel'
    ...
    LocalVarOutStrings(122) = 'NACIMU_FA_AccF'
    LocalVarOutStrings(123) = 'FA_AccF'
    LocalVarOutStrings(124) = 'FA_Hist'
    LocalVarOutStrings(125) = 'TRA_LastRefSpd'
    LocalVarOutStrings(126) = 'VS_RefSpeed'
    LocalVarOutStrings(127) = 'PtfmTDX'
    LocalVarOutStrings(128) = 'PtfmTDY'
    LocalVarOutStrings(129) = 'PtfmTDZ'
    LocalVarOutStrings(130) = 'PtfmRDX'
    LocalVarOutStrings(131) = 'PtfmRDY'
    LocalVarOutStrings(132) = 'PtfmRDZ'
    LocalVarOutStrings(133) = 'PtfmTVX'
    LocalVarOutStrings(134) = 'PtfmTVY'
    LocalVarOutStrings(135) = 'PtfmTVZ'
    LocalVarOutStrings(136) = 'PtfmRVX'
    LocalVarOutStrings(137) = 'PtfmRVY'
    LocalVarOutStrings(138) = 'PtfmRVZ'
    LocalVarOutStrings(139) = 'PtfmTAX'
    LocalVarOutStrings(140) = 'PtfmTAY'
    LocalVarOutStrings(141) = 'PtfmTAZ'
    LocalVarOutStrings(142) = 'PtfmRAX'
    LocalVarOutStrings(143) = 'PtfmRAY'
    LocalVarOutStrings(144) = 'PtfmRAZ'
    LocalVarOutStrings(145) = 'PtfmRDX_F'
    LocalVarOutStrings(146) = 'PtfmRDY_F'
    LocalVarOutStrings(147) = 'Force_Pitch'
    LocalVarOutStrings(148) = 'Force_Roll'
    LocalVarOutStrings(149) = 'StC_FR_Target'
    LocalVarOutStrings(150) = 'StC_FP_Target'
    LocalVarOutStrings(151) = 'StC_Fi_Target'
    LocalVarOutStrings(152) = 'StC_Fill_State'
    LocalVarOutStrings(153) = 'CC_DesiredL'
    LocalVarOutStrings(154) = 'CC_ActuatedL'
    LocalVarOutStrings(155) = 'CC_ActuatedDL'
    LocalVarOutStrings(156) = 'StC_Input'
    LocalVarOutStrings(157) = 'Flp_Angle'
    LocalVarOutStrings(158) = 'RootMyb_Last'
    LocalVarOutStrings(159) = 'ACC_INFILE_SIZE'
    LocalVarOutStrings(160) = 'AWC_complexangle'
    LocalVarOutStrings(161) = 'TiltMean'
    LocalVarOutStrings(162) = 'YawMean'
    LocalVarOutStrings(163) = 'ZMQ_ID'
    LocalVarOutStrings(164) = 'ZMQ_YawOffset'
    LocalVarOutStrings(165) = 'ZMQ_TorqueOffset'
    LocalVarOutStrings(166) = 'ZMQ_PitOffset'
    LocalVarOutStrings(167) = 'ZMQ_R_Speed'
    LocalVarOutStrings(168) = 'ZMQ_R_Torque'
    LocalVarOutStrings(169) = 'ZMQ_R_Pitch'
    ...
    IF ((LocalVar%iStatus == 0) .OR. (LocalVar%iStatus == -9))  THEN ! .TRUE. if we're on the first call to the DLL
        ...
        IF (CntrPar%LoggingLevel > 1) THEN
            ...
            WRITE(UnDb2, '(170(a20,TR5:))') 'Time',   LocalVarOutStrings
            WRITE(UnDb2, '(170(a20,TR5:))')
        END IF
    ...
    IF (MODULO(LocalVar%Time, 10.0_DbKi) == 0) THEN
        WRITE(CntrPar%UnScr, 100) LocalVar%GenSpeedF*RPS2RPM, LocalVar%BlPitch(1)*R2D, avrSWAP(15)/1000.0, LocalVar%WE_Vw
    ...
    ! Write debug files
    FmtDat = "(F20.5,TR5,169(ES20.5E2,TR5:))"   ! The format of the debugging data
